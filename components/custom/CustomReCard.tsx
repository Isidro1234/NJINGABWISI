...
export default function CustomReCard({link}:{link:string}) {
  ...
  return (
    <VStack width={'100%'} alignItems={'center'} justifyContent={'center'}>
       ...
       <Button onClick={()=>{router.push(`${link}`)}}  fontSize={11} color={'white'} bg={'#2F61BC'} borderRadius={50}>Registrar Imóvel</Button>
    </VStack>
  )
}
