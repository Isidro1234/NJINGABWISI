...
export default function UIPprint({ref}:{ref:any}) {
  ...
  return (
    <VStack gap={5} ref={ref} bg={'white'} width={'100%'} padding={10}>
         <VStack width={'100%'}>
                    <Image
        ...
        <HStack borderStyle={'dashed'} borderWidth={1.5} alignItems={'flex-start'} gap={5} padding={4} borderRadius={10} bg={'#ffffff'}>
            <Box padding={2} borderRadius={10} position={'relative'} width={150} height={150}>
              <Image fill style={{objectFit:"cover",borderRadius:10, height:'100%', width:'100%'}} src={decrypt?.photo}  alt='imge'/>  
            </Box>
            <Box flex={1}>
                <HStack  gap={1} width={'100%'} alignItems={'center'} justifyContent={'end'}>
                ...
                <HStack marginTop={2} gap={4} justifyContent={'flex-start'}>
                    <Box>
                ...
                <Box paddingTop={4} width={'100%'} display={'flex'} justifyContent={'end'}>
